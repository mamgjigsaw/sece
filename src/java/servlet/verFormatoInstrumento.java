 ...
 * @author Mendieta
 */
public class verFormatoInstrumento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Indicador> list = idi.findAllByActive();
         ...
         try
       {
      JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("WEB-INF/instrumentReport.jasper"));
