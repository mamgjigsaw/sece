<%-- 
    Document   : error404
    Created on : Feb 26, 2012, 4:00:29 PM
    Author     : mamg
--%>
...
<div class="main">
  <div class="header">
    <div class="header_resize">      
        <a href="initCapacitador.jsp" class="buttonVolver">&LT;&LT; Atras</a>
      <div class="menu">
  ...
  <div class="body">
    ...
    <div class="body_resize">
        ...
        <div align="center">
              ...
              <a title="descripcion"><img src="images/error page.png" alt="descripcion" /></a>
         </div>         
