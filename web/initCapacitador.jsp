        ...
        <script>
           ...
           var urlSistema;             
            ...
            function result(data){
                if (data==1){
                    //envio satisfactorio
                    $("#tab-4").prepend("<div class='notification success'><a href='JavaScript:void(0);' onclick= '$(this).parent().hide();' class='close-notification' title='Hide Notification' rel='tooltip'>x</a><p class='hola'><strong class='hola'>Correo Enviado</strong><p class='hola'>El correo fue enviado satisfactoriamente!!</p></div>");
                }
                else if(data==0){
                    $("#tab-4").prepend("<div class='notification error'><a href='JavaScript:void(0);' onclick= '$(this).parent().hide();' class='close-notification' title='Hide Notification' rel='tooltip'>x</a><p class='hola'><strong class='hola'>Envio Fallado</strong><p class='hola'>No se envio el correo!!</p></div>");
                }
                $("#imgBi").remove();
                $(".body_resize").show();
            }
